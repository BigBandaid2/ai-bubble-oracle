...
def build_svg(payload):
  ...
  <text x="43" y="150" font-size="41" font-weight="800" fill="#eef1f6" letter-spacing="-1.2">AI boom mapped to</text>
  <text x="43" y="196" font-size="41" font-weight="800" fill="#eef1f6" letter-spacing="-1.2">Dot-com bubble timeline</text>
  <text x="45" y="238" font-size="15" font-weight="700" fill="#ff5a44" letter-spacing="2.5">PROJECTED PEAK</text>
  <text x="42" y="296" font-size="56" font-weight="800" fill="#ff5a44" letter-spacing="-1.6">{date}</text>
